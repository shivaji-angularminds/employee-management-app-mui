import {
  ...
  function Form3(props) {
    ...
    const [data, setData] = useState(dataArray[props.index]);
   ...
   useEffect(()=>{
       console.log("wefjvbfehb ")
    findStateCode(data.state)
   },[data.state])
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  value="reading"
                  name="reading"
                  checked={data.hobbies.includes("reading") ? true:false}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  name="playing"
                  id={1}
                  checked={data.hobbies.includes("playing") ? true:false}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  name="singing"
                  id={2}
                  checked={data.hobbies.includes("singing") ? true:false}
